...
4. **Brainstorm Gate:** Missing context (affected layers? acceptance criteria? dependencies?) → List
   gaps, use the available structured user-input tool or ask one concise question, wait for the
   response, and re-run the gate. NO assumptions, NO placeholder steps.
