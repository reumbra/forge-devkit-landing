...
export const simulator: SimulatorI18n = {
	sectionLabel: "PRODUCT ASSEMBLY",
	headline: "How do you work with AI?",
	subheadline: "Pick your role. See what Forge builds for you.",
	ui: {
		...
		customizeHint: "Toggle capabilities to see how coverage changes.",
	},
	personas: [
		{
			id: "starter",
			title: "Solo Builder",
			description: "AI respects my architecture. 2 modules, zero overhead.",
	...
	capabilities: [
		...
		{ id: "taskSync", label: "Task Tracker Sync", description: "AI reads tasks, syncs status, validates AC on close" },
		{ id: "prompts", label: "Prompt Engineering", description: "Manage, test, and evolve prompts like code" },
		{ id: "agentTeams", label: "AI Agent Teams", description: "Multiple agents work in parallel with conflict prevention" },
		{ id: "marketValidation", label: "Market Validation", description: "Research, positioning, and launch planning before code" },
		{ id: "seoContent", label: "SEO & Brand Voice", description: "Technical SEO audit, schema markup, content strategy" },
		{ id: "growthRetention", label: "Growth & Retention", description: "Retention loops, A/B testing, onboarding, analytics" },
	],
	metrics: [
		{
			id: "architecture",
		...
		},
		{
			...
			fullImpact: "Tests auto-generated from acceptance criteria. Coverage tracked to requirements.",
		},
		{
			id: "taskTracking",
			label: "Task Tracking",
		...
		},
		{
			...
			fullImpact: "Agent teams work in parallel with automatic conflict prevention.",
		},
		{
			id: "marketValidation",
	...
	recommendations: {
		...
		full: "Every process covered - from market validation to growth experiments. Nothing left to manual guesswork.",
	},
	cta: {
		toStarter: "Start with Starter - \u20ac29 \u2192",
		toPro: "Upgrade to Pro for dev pipeline coverage \u2192",
		toComplete: "Get Complete for full coverage \u2192",
		alreadyFull: "You're fully covered! Get Complete \u2192",
	},
	crossCutting: {
...
const simulatorRu: SimulatorI18n = {
	sectionLabel: "СБОРКА ПРОДУКТА",
	headline: "Как вы работаете с AI?",
	subheadline: "Выберите роль. Посмотрите, что Forge соберет для вас.",
	ui: {
		buildButton: "\u0421\u043e\u0431\u0440\u0430\u0442\u044c \u043f\u0440\u043e\u0434\u0443\u043a\u0442",
		rebuildButton: "\u041f\u0435\u0440\u0435\u0441\u043e\u0431\u0440\u0430\u0442\u044c",
		metricsHeadline: "\u0417\u0434\u043e\u0440\u043e\u0432\u044c\u0435 \u043f\u0440\u043e\u0434\u0443\u043a\u0442\u0430",
		overallLabel: "\u041e\u0431\u0449\u0430\u044f \u0433\u043e\u0442\u043e\u0432\u043d\u043e\u0441\u0442\u044c",
	...
	personas: [
		{
			...
			description: "AI \u0443\u0432\u0430\u0436\u0430\u0435\u0442 \u043c\u043e\u044e \u0430\u0440\u0445\u0438\u0442\u0435\u043a\u0442\u0443\u0440\u0443. 2 \u043c\u043e\u0434\u0443\u043b\u044f, \u043d\u043e\u043b\u044c \u043e\u0432\u0435\u0440\u0445\u0435\u0434\u0430.",
	...
	capabilities: [
		...
		{ id: "taskSync", label: "\u0421\u0438\u043d\u0445\u0440\u043e\u043d\u0438\u0437\u0430\u0446\u0438\u044f \u0441 \u0442\u0440\u0435\u043a\u0435\u0440\u043e\u043c", description: "AI \u0447\u0438\u0442\u0430\u0435\u0442 \u0437\u0430\u0434\u0430\u0447\u0438, \u0441\u0438\u043d\u0445\u0440\u043e\u043d\u0438\u0437\u0438\u0440\u0443\u0435\u0442 \u0441\u0442\u0430\u0442\u0443\u0441, \u043f\u0440\u043e\u0432\u0435\u0440\u044f\u0435\u0442 AC" },
		{ id: "prompts", label: "\u041f\u0440\u043e\u043c\u043f\u0442-\u0438\u043d\u0436\u0435\u043d\u0435\u0440\u0438\u044f", description: "\u0423\u043f\u0440\u0430\u0432\u043b\u044f\u0439, \u0442\u0435\u0441\u0442\u0438\u0440\u0443\u0439 \u0438 \u0440\u0430\u0437\u0432\u0438\u0432\u0430\u0439 \u043f\u0440\u043e\u043c\u043f\u0442\u044b \u043a\u0430\u043a \u043a\u043e\u0434" },
		{ id: "agentTeams", label: "\u041a\u043e\u043c\u0430\u043d\u0434\u044b AI-\u0430\u0433\u0435\u043d\u0442\u043e\u0432", description: "\u041d\u0435\u0441\u043a\u043e\u043b\u044c\u043a\u043e \u0430\u0433\u0435\u043d\u0442\u043e\u0432 \u0440\u0430\u0431\u043e\u0442\u0430\u044e\u0442 \u043f\u0430\u0440\u0430\u043b\u043b\u0435\u043b\u044c\u043d\u043e \u0431\u0435\u0437 \u043a\u043e\u043d\u0444\u043b\u0438\u043a\u0442\u043e\u0432" },
		{ id: "marketValidation", label: "\u0412\u0430\u043b\u0438\u0434\u0430\u0446\u0438\u044f \u0440\u044b\u043d\u043a\u0430", description: "\u0418\u0441\u0441\u043b\u0435\u0434\u043e\u0432\u0430\u043d\u0438\u0435, \u043f\u043e\u0437\u0438\u0446\u0438\u043e\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 \u0438 \u043f\u043b\u0430\u043d \u0437\u0430\u043f\u0443\u0441\u043a\u0430 \u0434\u043e \u043a\u043e\u0434\u0430" },
		{ id: "seoContent", label: "SEO \u0438 \u0433\u043e\u043b\u043e\u0441 \u0431\u0440\u0435\u043d\u0434\u0430", description: "\u0422\u0435\u0445\u043d\u0438\u0447\u0435\u0441\u043a\u0438\u0439 SEO-\u0430\u0443\u0434\u0438\u0442, schema markup, \u043a\u043e\u043d\u0442\u0435\u043d\u0442-\u0441\u0442\u0440\u0430\u0442\u0435\u0433\u0438\u044f" },
		{ id: "growthRetention", label: "\u0420\u043e\u0441\u0442 \u0438 \u0443\u0434\u0435\u0440\u0436\u0430\u043d\u0438\u0435", description: "\u041f\u0435\u0442\u043b\u0438 retention, A/B-\u0442\u0435\u0441\u0442\u044b, \u043e\u043d\u0431\u043e\u0440\u0434\u0438\u043d\u0433, \u0430\u043d\u0430\u043b\u0438\u0442\u0438\u043a\u0430" },
	],
	metrics: [
		{
			id: "architecture",
		...
		},
		{
			...
			fullImpact: "\u0422\u0435\u0441\u0442\u044b \u0433\u0435\u043d\u0435\u0440\u0438\u0440\u0443\u044e\u0442\u0441\u044f \u0438\u0437 acceptance criteria. \u041f\u043e\u043a\u0440\u044b\u0442\u0438\u0435 \u043e\u0442\u0441\u043b\u0435\u0436\u0438\u0432\u0430\u0435\u0442\u0441\u044f \u0434\u043e \u0442\u0440\u0435\u0431\u043e\u0432\u0430\u043d\u0438\u0439.",
		},
		{
			id: "taskTracking",
			label: "\u0422\u0440\u0435\u043a\u0438\u043d\u0433 \u0437\u0430\u0434\u0430\u0447",
		...
		},
		{
			...
			fullImpact: "\u041a\u043e\u043c\u0430\u043d\u0434\u044b \u0430\u0433\u0435\u043d\u0442\u043e\u0432 \u0440\u0430\u0431\u043e\u0442\u0430\u044e\u0442 \u043f\u0430\u0440\u0430\u043b\u043b\u0435\u043b\u044c\u043d\u043e \u0441 \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438\u043c \u043f\u0440\u0435\u0434\u043e\u0442\u0432\u0440\u0430\u0449\u0435\u043d\u0438\u0435\u043c \u043a\u043e\u043d\u0444\u043b\u0438\u043a\u0442\u043e\u0432.",
		},
		{
			id: "marketValidation",
			label: "\u0412\u0430\u043b\u0438\u0434\u0430\u0446\u0438\u044f \u0440\u044b\u043d\u043a\u0430",
			zeroImpact: "\u041d\u0435\u0442 \u043f\u0440\u043e\u0446\u0435\u0441\u0441\u0430 \u0432\u0430\u043b\u0438\u0434\u0430\u0446\u0438\u0438 - \u043f\u0440\u043e\u0434\u0443\u043a\u0442\u043e\u0432\u044b\u0435 \u0440\u0435\u0448\u0435\u043d\u0438\u044f \u0441\u0442\u0440\u043e\u044f\u0442\u0441\u044f \u043d\u0430 \u043f\u0440\u0435\u0434\u043f\u043e\u043b\u043e\u0436\u0435\u043d\u0438\u044f\u0445.",
			fullImpact: "Discovery, \u0438\u043d\u0442\u0435\u0440\u0432\u044c\u044e \u0438 \u043f\u0440\u043e\u0432\u0435\u0440\u043a\u0430 \u043d\u0430 bias \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043d\u044b \u0434\u043e \u043f\u0435\u0440\u0432\u043e\u0433\u043e \u043a\u043e\u043c\u043c\u0438\u0442\u0430.",
		},
		{
			id: "seoContent",
			label: "SEO \u0438 \u043a\u043e\u043d\u0442\u0435\u043d\u0442",
	...
	recommendations: {
		...
		full: "\u0412\u0441\u0435 \u043f\u0440\u043e\u0446\u0435\u0441\u0441\u044b \u043f\u043e\u043a\u0440\u044b\u0442\u044b - \u043e\u0442 \u0432\u0430\u043b\u0438\u0434\u0430\u0446\u0438\u0438 \u0440\u044b\u043d\u043a\u0430 \u0434\u043e \u044d\u043a\u0441\u043f\u0435\u0440\u0438\u043c\u0435\u043d\u0442\u043e\u0432 \u0440\u043e\u0441\u0442\u0430. \u041d\u0438\u0447\u0435\u0433\u043e \u043d\u0435 \u043e\u0441\u0442\u0430\u0432\u043b\u0435\u043d\u043e \u043d\u0430 \u0443\u0433\u0430\u0434\u044b\u0432\u0430\u043d\u0438\u0435.",
	},
	cta: {
		toStarter: "\u041d\u0430\u0447\u043d\u0438\u0442\u0435 \u0441\u043e Starter - \u20ac29 \u2192",
		toPro: "\u041f\u0435\u0440\u0435\u0439\u0434\u0438\u0442\u0435 \u043d\u0430 Pro \u0434\u043b\u044f \u043f\u043e\u043a\u0440\u044b\u0442\u0438\u044f dev pipeline \u2192",
		toComplete: "\u041f\u043e\u043b\u0443\u0447\u0438\u0442\u0435 Complete \u0434\u043b\u044f \u043f\u043e\u043b\u043d\u043e\u0433\u043e \u043f\u043e\u043a\u0440\u044b\u0442\u0438\u044f \u2192",
		alreadyFull: "\u041f\u043e\u043b\u043d\u043e\u0435 \u043f\u043e\u043a\u0440\u044b\u0442\u0438\u0435! \u041f\u043e\u043b\u0443\u0447\u0438\u0442\u0435 Complete \u2192",
	},
	crossCutting: {
		module: "forge-prompts",
		slug: "prompts",
